...
#include <linux/nl80211.h> // Include NL80211 headers
#include <libubus.h>
...
// int nl80211_get_survey(const char *ifname, struct dump_state *wireless_state);
// int nl80211_get_station_dump(const char *ifname, struct dump_state *wireless_state, char *mac);
...
// static int get_antenna_details(void)
// {
//     char ifname[16];
//     int wiphy;
//     char current_mac[18];
//     enum nl80211_iftype iftype;
//     struct dump_state nl_state;
//     char associated_mac[18];

//     if (nl80211_init(ifname, &wiphy, current_mac, &iftype) != 0) {
// 		syslog(6,"Failed to init the nl80211 connection for the ifname '%s'",
// 				ifname);
// 		return 1;
// 	}
// 	/* Get wireless survey dump*/
// 	if (nl80211_get_survey(ifname, &nl_state) == -1) {
// 		syslog(6,"Failed get nl80211 survey");
// 		return 1;
// 	}

//     /* Get wireless station dump*/
// 	if (nl80211_get_station_dump(ifname, &nl_state, associated_mac) == -1 &&
// 		iftype != NL80211_IFTYPE_STATION) {
// 		syslog(6,"Failed get nl80211 station dump");
// 		return 1;
// 	}
//     return 0;
// }
